...
void IntegDeriv::MidRule(double xi, double xf, double& Integral, double& Error,int numPoints){
...
void IntegDeriv::simpsonRule(double xi, double xf, double& Integral, double& Error,int numPoints){
    double h = (xf - xi) / numPoints;  // Step size
